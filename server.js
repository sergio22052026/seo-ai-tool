...
app.post('/api/suggest', async (req, res) => {
  ...
  const { company, website, city, comune, provincia, settore, kwCount, bizType, rilevanza, visibilita } = req.body;
...
${settoreDesc}
ATTENZIONE: Le keyword e i competitor devono essere ESCLUSIVAMENTE pertinenti al settore "${settore||'indicato'}" e all'area geografica di ${cityName} e dintorni. NON suggerire keyword di altri settori o altre zone geografiche non correlate.
